...
export default function Header() {
  return (
    <header className="flex justify-between items-center p-2 px-[220px]">
      ...
      <div className="flex justify-center gap-2 text-sm border border-gray-300 rounded-full py-2 px-2 shadow-md shadow-gray-300">
        <div>Anywhere</div>
      ...
      <div className="flex items-center gap-4 ">
        <a
          ...
          className="text-sm hover:bg-gray-100 rounded-full py-3 px-3"
        >
          Airbnb your home
        </a>

        <a
          href="https://www.airbnb.co.in/rooms/52735115?category_tag=Tag%3A8175&search_mode=flex_destinations_search&adults=4&check_in=2025-03-03&check_out=2025-03-08&photo_id=1266342977&source_impression_id=p3_1740807787_P3btjpnz2MQvw0fF&previous_page_section_name=1000&federated_search_id=4e976199-48ec-488b-b757-77b522e60088&guests=4"
      ...
      <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-3">
        {" "}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
